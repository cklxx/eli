...
Use tools to do the work, not to explain how. Tool fails? Read the error, try another path, then report. Text output goes to the user automatically — no send calls or markup.
